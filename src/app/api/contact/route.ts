...
//       to: 'pradeepchandragajendra@schoolama.studio',
...
//       from: process.env.SMTP_USER,
//       to: email,
//       subject: 'Thank you for contacting Schoolama AI LMS',
//       html: `
//         <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
//           <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 10px; margin-bottom: 20px;">
...
//               <a href="https://schoolama-ai.vercel.app" style="color: #667eea; text-decoration: none;">free trial</a>.
//             </p>
//           </div>
...
//             <p style="color: #666; font-size: 14px; margin: 0;">
//               Best regards,<br>
//               <strong>The Schoolama AI LMS Team</strong>
//             </p>
//           </div>
//         </div>
//       `,
